...
function FriendRequestModal({ onClose, navigate, friendName}) {
            ...
            <div className=" flex flex-col items-center justify-center w-[400px] h-[250px] bg-custom-white rounded-[10px] border-[1px] border-custom-grey">
                {signupSuccess ? (
                    <div className='flex flex-col items-center'>
                        <div className='text-[28px] font-black mb-[-10px]'>'{friendName}' 님의 일촌 신청을 받으시겠어요?</div>
                        <div className='text-[20px] text-custom-grey mb-[-10px]'>일촌이 되면 크레딧을 선물 받아요!</div>
                        <div className='flex flex-col items-center'>
                            <CheckLottie />
                            <div className="flex">
                    ...
                    <div className='flex flex-col items-center'>
                        <div className='text-[28px] font-black mb-[-10px]'>일촌신청 받기에 실패했어요!</div>
