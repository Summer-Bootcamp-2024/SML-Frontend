...
function ProfileSlide({ isOpen, openIntroduceModal, onCloseSlide, ProfileId }) {
    ...
    return (
        <div
            className={`absolute w-[450px] top-[30%] rounded-[10px] border-2 border-custom-blue right-20 h-[calc(100vh-100px)] pb-[3%] bg-custom-skyblue transition-transform duration-300 overflow-y-scroll ${isOpen ? '' : 'translate-x-[400px]'}`}
            >
